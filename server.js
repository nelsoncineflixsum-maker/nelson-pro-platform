...
// 🛠️ CONEXÃO BANCO NEON (Sua Chave Mestra)
const pool = new Pool({ 
...
app.post('/api/auth/register', async (req, res) => {
    ...
    try {
        ...
        res.status(400).json({ success: false, message: 'Erro ao cadastrar' });
    }
});
...
app.listen(PORT, '0.0.0.0', () => console.log(`🚀 Nelson Pro Online na porta ${PORT}`));
